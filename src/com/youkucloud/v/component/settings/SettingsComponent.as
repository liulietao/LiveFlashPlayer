package com.youkucloud.v.component.settings
{
	import com.greensock.TweenLite;
	import com.youkucloud.consts.PlayerColor;
	...
	public class SettingsComponent extends BaseComponent
	{
		...
		{
			var windowWidth:int = (stageWidth*0.3 > 350)? stageWidth*0.3: 350;
			var widnowHeight:int = (stageHeight*0.3 > 110)? stageHeight*0.3: 110;
			
			var g:Graphics = this.graphics;
			g.beginFill(PlayerColor.MAIN_BG, 0.8);
			g.drawRoundRect(0, 0, windowWidth, widnowHeight, 10, 10);
			g.endFill();
