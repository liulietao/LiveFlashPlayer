package com.youkucloud.v.component
{
	...
	import com.youkucloud.util.Stretcher;
	...
	{
		private var  _log:LogUtil = new LogUtil("VideoAdsComponent");
		...
		{
			_m.developermode && (_log.error('VideoAdsComponent', '加载视频ioError', evt.toString()));
		}
		
		private function statusHandler(evt:NetStatusEvent):void
		{
			_log.debug('VideoAdsComponent', evt.info.code + '--' + _stream.time + '--' + _dur);
			_m.developermode && (_log.info('VideoAdsComponent', evt.info.code + '--' + _stream.time + '--' + _dur));
