package com.youkucloud.v.component
{
	...
	{
		private var  _log:LogUtil = new LogUtil("ControlBarComponent");
		...
		{
			_log.debug("volumeChangeHandler: ", pct);
			_iconY = iconY;
